...
<body>
  ...
  <form action="set_producto_v2.php" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
    <fieldset>
      ...
      <ul>
        <label for="nombre">Nombre del Reloj:</label><input type="text" id="nombre" name="nombre" value="<?= $_GET['nombre']; ?>" required ><br>
        ...
        <label for="modelo">Modelo:</label><input type="text" id="modelo" name="modelo" value="<?= $_GET['modelo']; ?>" required><br>
        <label for="precio">Precio:</label><input type="number" id="precio" name="precio" step="0.01" value="<?= $_GET['precio']; ?>"required><br>
        <label for="detalles">Detalles (opcional):</label><input type="text" id="detalles" name="detalles" value="<?= $_GET['detalles']; ?>"><br>
        <label for="unidades">Unidades:</label><input type="number" id="unidades" name="unidades" value="<?= $_GET['unidades']; ?>" required><br>
        <label for="imagen">Imagen:</label><input type="file" id="imagen" name="imagen" accept="image/*" value="<?= $_GET['imagen']; ?>"><br>
      </ul>
    </fieldset>
